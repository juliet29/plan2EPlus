...
from new_subsurfaces.geometry_interfaces import Domain, Range
...
def plot_subsurface_and_surface(idf:IDF, subsurface: EpBunch):
    ...
    assert surface
    surface_dict = create_domain_for_rectangular_wall(surface).get_dict_for_plotting(COLOR_1)
    subsuface_dict = create_domain_for_subsurface(subsurface).get_dict_for_plotting(COLOR_2)
